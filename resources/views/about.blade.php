...
@php
    $navMenu = [
        ...
        ['route'=>'about','label'=>'Tentang','active'=>true],
        ['route'=>'products','label'=>'Produk','active'=>false],
        ['route'=>'contact','label'=>'Hubungi Kami','active'=>false],
    ];
...
<main class="max-w-screen-xl mx-auto px-4 sm:px-6 py-10 space-y-10">
    ...
    <section class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        @foreach([
            [
                'title'=>'Visi',
                'heading'=>'Menjadi platform rental perlengkapan yang mudah diakses semua orang.',
                'desc'=>'Kami ingin membantu pelanggan menemukan dan menyewa perlengkapan yang dibutuhkan tanpa proses yang ribet.'
            ],
            [
                'title'=>'Misi',
                'heading'=>'Menyediakan pengalaman sewa yang simpel dan terpercaya.',
                'desc'=>'Mulai dari pemilihan produk, penjadwalan sewa, hingga pembayaran, semua dirancang agar pelanggan bisa menyewa dengan nyaman.'
            ]
        ] as $item)
