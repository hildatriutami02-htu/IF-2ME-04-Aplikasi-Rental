    ...
    <section class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
            ...
            <div>
                ...
                <select class="w-full rounded-2xl border border-slate-300 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500">
    ...
    <section class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
                ...
                <div class="p-5">
                    <div class="flex items-start justify-between gap-3">
                        <div>
                            ...
                            <h3 class="mt-3 text-lg font-bold text-slate-800">{{ $item['nama'] }}</h3>
                        </div>
                    ...
                    <p class="mt-3 text-sm leading-6 text-slate-500">{{ $item['deskripsi'] }}</p>

                    <div class="mt-5 grid grid-cols-2 gap-3 text-sm">
                        <div class="rounded-2xl bg-slate-50 px-4 py-3">
                            <p class="text-slate-500">Harga</p>
                            <p class="mt-1 font-bold text-blue-600">Rp {{ number_format($item['harga'], 0, ',', '.') }}</p>
                        </div>
                        <div class="rounded-2xl bg-slate-50 px-4 py-3">
                            <p class="text-slate-500">Stok</p>
                            <p class="mt-1 font-bold text-slate-800">{{ $item['stok'] }}</p>
                        </div>
                    </div>
        ...
        @empty
            <div class="col-span-full rounded-3xl border border-slate-200 bg-white p-10 text-center shadow-sm">
                <div class="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-slate-100 text-3xl text-slate-400">📦</div>
